...
canvas = tkinter.Canvas(main, width=screen_width, height=screen_height)
canvas.pack()
canvas.create_image(0, 0, anchor=tkinter.NW, image=background_photo)
...
font = ('times', 16, 'bold')
title = Label(main, text='Privacy Preservation System Using Machine Learning',anchor=W, justify=LEFT)
...
pathlabel.config(bg='#040720', fg='white')  
